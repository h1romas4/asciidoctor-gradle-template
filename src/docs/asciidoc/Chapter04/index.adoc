...
[source]
[caption=""]
.``diag-nwdiag-network1.puml``（分かりやすいように https://github.com/h1romas4/asciidoctor-gradle-template/blob/master/src/docs/asciidoc/Chapter04/puml/diag-nwdiag-network1.puml[実際のソース]より簡略化）
-----
...
[source]
[caption=""]
.``diag-timing-sample1.puml``（分かりやすいよう https://github.com/h1romas4/asciidoctor-gradle-template/blob/master/src/docs/asciidoc/Chapter04/puml/diag-timing-sample1.puml[実際のソース]より抜粋）
-----
